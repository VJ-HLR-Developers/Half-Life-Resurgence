...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--[[
	ent.HLR_Type = Classifies common type of NPCs
		"Headcrab"
		"Turret"
		"Police"
		"Citizen"
...
VJ.AddConVar("vj_hlr1_hd_enabled", 0, {FCVAR_ARCHIVE})
-- Source
