...
ENT.SoundTbl_OnCollide = {"vj_hlr/hla_npc/hornet/ag_buzz1.wav","vj_hlr/hla_npc/hornet/ag_buzz2.wav","vj_hlr/hla_npc/hornet/ag_buzz3.wav"}
...
function ENT:CustomOnPhysicsCollide(data, phys)
	...
	phys:SetVelocity(newVel * lastVel * 0.05)
	self:SetAngles(self:GetVelocity():GetNormal():Angle())
end
---------------------------------------------------------------------------------------------------------------------------------------------
