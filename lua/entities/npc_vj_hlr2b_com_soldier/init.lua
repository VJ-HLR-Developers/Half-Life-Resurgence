...
ENT.SoundTbl_CombatIdle = {
	"vj_hlr/hl2b_npc/combine/go_alert1.wav",
	"vj_hlr/hl2b_npc/combine/go_alert2.wav",
	"vj_hlr/hl2b_npc/combine/go_alert3.wav",
}
ENT.SoundTbl_LostEnemy = {
	"vj_hlr/hl2b_npc/combine/lost_long1.wav",
	"vj_hlr/hl2b_npc/combine/lost_long2.wav",
	"vj_hlr/hl2b_npc/combine/lost_long3.wav",
	"vj_hlr/hl2b_npc/combine/lost_short1.wav",
	"vj_hlr/hl2b_npc/combine/lost_short2.wav",
	"vj_hlr/hl2b_npc/combine/lost_short3.wav",
}
ENT.SoundTbl_Alert = {
	"vj_hlr/hl2b_npc/combine/announce1.wav",
	"vj_hlr/hl2b_npc/combine/announce2.wav",
	"vj_hlr/hl2b_npc/combine/announce3.wav",
	"vj_hlr/hl2b_npc/combine/refind_enemy1.wav",
	"vj_hlr/hl2b_npc/combine/refind_enemy2.wav",
	"vj_hlr/hl2b_npc/combine/refind_enemy3.wav",
}
ENT.SoundTbl_GrenadeAttack = {
	"vj_hlr/hl2b_npc/combine/throw_grenade1.wav",
	"vj_hlr/hl2b_npc/combine/throw_grenade2.wav",
	"vj_hlr/hl2b_npc/combine/throw_grenade3.wav",
}
ENT.SoundTbl_OnGrenadeSight = {
	"vj_hlr/hl2b_npc/combine/spot_grenade1.wav",
	"vj_hlr/hl2b_npc/combine/spot_grenade2.wav",
	"vj_hlr/hl2b_npc/combine/spot_grenade3.wav",
}
ENT.SoundTbl_OnKilledEnemy = {
	"vj_hlr/hl2b_npc/combine/player_dead1.wav",
	"vj_hlr/hl2b_npc/combine/player_dead2.wav",
	"vj_hlr/hl2b_npc/combine/player_dead3.wav",
}
ENT.SoundTbl_AllyDeath = {
	"vj_hlr/hl2b_npc/combine/man_down1.wav",
	"vj_hlr/hl2b_npc/combine/man_down2.wav",
	"vj_hlr/hl2b_npc/combine/man_down3.wav",
}
ENT.SoundTbl_Pain = {
	"vj_hlr/hl2b_npc/combine/assault1.wav",
	"vj_hlr/hl2b_npc/combine/assault2.wav",
	"vj_hlr/hl2b_npc/combine/assault3.wav",
}
ENT.SoundTbl_Death = {
	"vj_hlr/hl2b_npc/combine/die1.wav",
	"vj_hlr/hl2b_npc/combine/die2.wav",
	"vj_hlr/hl2b_npc/combine/die3.wav",
}
...
function ENT:OnPlayCreateSound(SoundData,SoundFile)
	if VJ_HasValue(self.SoundTbl_Death,SoundFile) then
		VJ_EmitSound(self,"vj_hlr/hl2b_npc/combine/click_terminated.wav")
		return
	end
	if VJ_HasValue(self.DefaultSoundTbl_MeleeAttack,SoundFile) then return end
	VJ_EmitSound(self,"vj_hlr/hl2b_npc/combine/clik.wav")
	timer.Simple(SoundDuration(SoundFile), function() if IsValid(self) && SoundData:IsPlaying() then VJ_EmitSound(self,"vj_hlr/hl2b_npc/combine/click_off.wav") end end)
end
---------------------------------------------------------------------------------------------------------------------------------------------
