...
function ENT:HandleGibOnDeath(dmginfo, hitgroup)
	...
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/hgib_b_gib.mdl", {CollisionDecal = "VJ_HLR1_Blood_Red", CollideSound = gibsCollideSd, Pos = self:LocalToWorld(Vector(0, 0, 41))})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/hgib_guts.mdl", {CollisionDecal = "VJ_HLR1_Blood_Red", CollideSound = gibsCollideSd, Pos = self:LocalToWorld(Vector(0, 0, 42))})
	...
	if self.SCI_Type == SCI_TYPE_KELLER then
		...
		self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/wheelchair_arm.mdl", {CollisionDecal = false, Pos = self:LocalToWorld(Vector(0, 15, 32)), Ang = self:LocalToWorldAngles(Angle(0, -10, 0)), CollisionSound = sdMetalCollide})
		self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/wheelchair_backwheel.mdl", {CollisionDecal = false, Pos = self:LocalToWorld(Vector(-15, -15, 5)), Ang = self:LocalToWorldAngles(Angle()), CollisionSound = sdMetalCollide})
		self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/wheelchair_backwheel.mdl", {CollisionDecal = false, Pos = self:LocalToWorld(Vector(-15, 15, 5)), Ang = self:LocalToWorldAngles(Angle()), CollisionSound = sdMetalCollide})
