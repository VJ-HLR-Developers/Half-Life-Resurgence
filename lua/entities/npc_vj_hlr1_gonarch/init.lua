...
ENT.EntitiesToNoCollide = {"npc_vj_hlr1_headcrab_baby","npc_vj_hlr1_headcrab"} -- Entities to not collide with when HasEntitiesToNoCollide is set to true
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:Gonarch_BabyDeath()
	...
	if CurTime() > self.Gonarch_NextDeadBirthT then
		...
		self:AllyDeathSoundCode({"vj_hlr/hl1_npc/gonarch/gon_childdie1.wav","vj_hlr/hl1_npc/gonarch/gon_childdie2.wav","vj_hlr/hl1_npc/gonarch/gon_childdie3.wav"})
