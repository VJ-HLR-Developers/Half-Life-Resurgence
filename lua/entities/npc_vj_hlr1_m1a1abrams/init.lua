...
-----------------------------------------------*/
ENT.Model = "models/vj_hlr/hl1/tank_body_destroyed.mdl" -- Model(s) to spawn with | Picks a random one if it's a table 
ENT.StartHealth = 500
ENT.VJC_Data = {
    ...
    FirstP_Offset = Vector(00, 0, 130), -- The offset for the controller when the camera is in first person
...
function ENT:Tank_CustomOnDeath_AfterCorpseSpawned(dmginfo, hitgroup, corpseEnt)
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p1_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 80)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p2_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 81)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p3_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 82)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p4_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 83)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p5_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 84)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p6_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 85)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p7_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 86)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p8_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 87)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p9_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 88)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p10_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 89)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p11_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 90)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p1_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 91)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p2_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 92)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p3_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 93)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p4_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 94)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p5_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 95)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p6_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 96)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p7_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 97)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p8_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 98)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p9_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(0, 0, 99)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p10_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(1, 0, 80)), CollideSound=metalCollideSD})
	self:CreateGibEntity("obj_vj_gib", "models/vj_hlr/gibs/metalgib_p11_g.mdl", {BloodDecal="", Pos=self:LocalToWorld(Vector(1, 1, 80)), CollideSound=metalCollideSD})
